...
Release one uses English, monthly USD subscriptions, MP4/MOV up to 2 GiB subject to stricter destination limits, and one connected Drive per user. Supported destinations are YouTube channels, authorized TikTok accounts, Facebook Pages, and Instagram professional accounts through the chosen Meta linked-Page flow. Personal Facebook profiles are excluded. Video editing, transcoding, AI generation, teams, engagement analytics, and a free trial are excluded.
...
| FR-05 | Composer and validation                   | Preview video; select unique destinations; save captions and per-platform settings; reject incompatible scheduled/now posts with a destination-specific explanation                                    |
...
| FR-09 | Server-side quotas                        | Count each destination once; reserve at dispatch, consume on publication, release on confirmed failure; concurrent work cannot exceed allowance; retries reuse the same usage record                   |
...
| Plan    | Monthly USD | Active social accounts | Destination posts / billing month |
| ------- | ----------- | ---------------------- | --------------------------------- |
| Starter | $9          | 4                      | 60                                |
| Creator | $19         | 10                     | 200                               |
| Pro     | $39         | 25                     | 600                               |
