...
| Spec Kit documents could be confused with installed tooling                            | Official upstream review documents absent CLI/integration/feature state and manual checklist      | T043 optional adoption; no fabricated command execution                                          |
